angular.module('flightApp').controller('flightController', ['flightService', '$http', '$state', 
function (flightService, $http, $state) {

this.flightService = flightService;

flightService.getLikes(this.tweet.id).then( (result) => {
